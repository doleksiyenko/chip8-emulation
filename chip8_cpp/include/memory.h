...
class Memory {
    ...
    public:
        std::unordered_map<uint8_t, uint8_t> hex_to_scancode_translation {{0x0, SDL_SCANCODE_1}, {0x1, SDL_SCANCODE_2}, {0x2, SDL_SCANCODE_3}, {0x3, SDL_SCANCODE_4},
        ...
        std::unordered_map<uint8_t, uint8_t> scancode_to_hex_translation; 
